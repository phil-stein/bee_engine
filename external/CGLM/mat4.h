...
#define glm_mat4_udup(mat, dest) glm_mat4_ucopy(_material, dest)
#define glm_mat4_dup(mat, dest)  glm_mat4_copy(_material, dest)

/* DEPRECATED! default is precise now. */
#define glm_mat4_inv_precise(mat, dest) glm_mat4_inv(_material, dest)
